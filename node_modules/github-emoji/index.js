...
exports.all = exports.of = exports.urlOf = exports.stringOf = exports.isName = exports.namesOf = exports.nameOf = exports.isEmoji = exports.URLS = void 0;
...
function urlOf(name) {
    ...
    return emoji_json_1.default[name];
}
exports.urlOf = urlOf;
function of(name) {
    if (!(name in emoji_json_1.default)) {
